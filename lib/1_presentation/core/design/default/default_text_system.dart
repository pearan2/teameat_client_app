...
class DefaultTextSystem extends ITextSystem {
  ...
  String get purchaseGroupBuyingOpenWarning =>
      '''{2인 팀구매 열기}중 이시네요! 아래 문구를 확인해주세요

1. 즉시 이용권 발급 X
  - 결제 후 {바로 이용권이 생성되지 않아요}
  - 결제 후 해당 메뉴의 2인 팀 구매가 오픈 돼요
2. 다른 유저 참여 필요
  - {다른 사용자가 팀 구매에 참가하면 이용권이 생성돼요}
  - 지인에게 팀 구매 참가를 부탁 해보세요!
3. 자동 환불
  - 24시간 내에 참여자가 없을 경우, {자동으로 100% 환불돼요}''';

  @override
  String get purchaseOnlyForAdultWarning =>
      '이 가게는 {주류를 위주로 취급하는 곳}이에요\n{성인이 아니시라면 이용권 사용에 제한}이 있을 수 있어요!';
