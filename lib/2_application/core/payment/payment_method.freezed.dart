...
abstract class $PaymentMethodCopyWith<$Res> {
  ...
  @useResult
  $Res call({String method, String value});
}
...
class _$PaymentMethodImpl implements _PaymentMethod {
  const _$PaymentMethodImpl({required this.method, required this.value});
  ...
  @override
  String toString() {
    return 'PaymentMethod(method: $method, value: $value)';
  }
...
abstract class _PaymentMethod implements PaymentMethod {
  const factory _PaymentMethod(
      ...
      required final String value}) = _$PaymentMethodImpl;
